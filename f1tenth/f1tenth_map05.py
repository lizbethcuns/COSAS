...
import python_motion_planning.curve_generation.cubic_spline as cs
...
# ================= PARTE B: SUAVIZADO =================
def smooth_path_cubic(path_world, ds=0.1):
    if len(path_world) < 3:
        return path_world
    ...
    rx, ry, ryaw, rk, s = cs.calc_spline_course(px, py, ds=ds)
...
if __name__ == "__main__":
    ...
    save_path_world_csv(path_05m, "Blpastar_05m.csv")

    # Parte B
    path_smooth = smooth_path_cubic(path_05m, ds=0.1)
    save_path_world_csv(path_smooth, "Blpastar_05smooth.csv")

    print("✔ Parte A: Blpastar_05m.csv")
    print("✔ Parte B (suavizado): Blpastar_smooth05.csv")
